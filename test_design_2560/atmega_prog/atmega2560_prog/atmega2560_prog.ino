...
const int latchPin = 35;   // Pin connected to ST_CP of 74HC595
const int clockPin = 37;   // Pin connected to SH_CP of 74HC595
const int dataPin = 36;    // Pin connected to DS of 74HC595

// Pins for digit selection (common cathodes for 5 digits)
const int digitPins[5] = {A13, A14, A15, A11, A12};  // Pins to control the 5 common cathodes of the displays
...
// BCD threshold pins
const int tempOnesPins[] = {22, 23, 24, 25};
const int tempTensPins[] = {26, 27, 28, LOW};
const int tempSignPin = 29;
const int humOnesPins[] = {53, 52, 51, 50};
const int humTensPins[] = {10, 11, 12, 13};
